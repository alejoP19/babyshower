    ...
    try {
      if (namesField == "" || last_nameField == "" || quantityField == "") {
        ...
        return new Promise((resp) => {
          Swal.fire({
            title: "Hello!",
            text: " Would you like to confirm your attendance?",
            icon: "question",
          }).then((resp) => {
            ...
            if (resp.isConfirmed) {
                ...
                let c = Swal.fire({
                  ...
                  html: '<b style="color:rgb(1, 255, 170);  text-shadow:-1px 1px 1px rgb(0, 0, 0)">Thank you for joining us!</b>',
                  // imageUrl: 'https://m.media-amazon.com/images/I/712wB01pHsL._AC_SL1001_.jpg',
                  imageUrl: '/static/invitados/img/alert_confirm_img.png',
                  imageWidth: "95%",
                  imageHeight: "85%",
